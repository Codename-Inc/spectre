...
- Research only if plan/context do not name target files/patterns: dispatch `@finder`, `@analyst`, `@patterns`; fold returns into `task_context.md` `## Technical Research`. Skip for LIGHT or clear single-component scope.
