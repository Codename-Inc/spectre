...
Return the completion report inline with the exact commands run and pass/fail evidence — no scratch files. Then render the inline Next Steps line: `caspar-clean` to tidy, or `caspar-test` for broader risk-based verification.
