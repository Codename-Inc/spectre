...
4. Register with the expected revision. Reconcile stale evidence by reloading and comparing it; preserve history. Surface contradictions with an explicit user decision. Already-authorized accepted facts need no new proposal or approval loop.
