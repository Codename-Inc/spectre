...
- Each scheduled review runs once. Group compatible defects into one consolidated root-cause repair pass; the primary handles bounded local work and uses `@spectre:dev` only for independent work or material context protection.
