...
- High-priority review or validation gaps → dispatch `@caspar:dev` to fix, rerun deterministic checks, then rerun `Skill(caspar-code_review)` or only the affected validation check.
