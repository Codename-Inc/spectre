...
- **Registry** (read first): `{{project_root}}/.agents/skills/spectre-recall/references/registry.toon` — lines `{skill-name}|{category}|{triggers}|{description}`.

## Working Set
- Skill files: `{{project_root}}/.agents/skills/{category}-{slug}/SKILL.md`.
- Recall skill + registry: `{{project_root}}/.agents/skills/spectre-recall/`.
