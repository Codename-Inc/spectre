...
Reads:
- Apply skill from plugin: skills/spectrl-apply/SKILL.md
- Registry from project: .claude/skills/spectrl-find/references/registry.toon
...
**Categories:** feature, gotchas, patterns, decisions, procedures, integration, performance, testing, ux, strategy"""
    ...
    # Build final context
    context = f"<spectrl-knowledge>\n{apply_content}\n</spectrl-knowledge>"

    # Visible notice
    visible_notice = f"⚡️spectrl: {entry_count} knowledge skills available"
