...
- **Action** — DispatchAgents: Spawn parallel `@spectrl:analyst` subagents to investigate top hypotheses
...
- **Action** — Load TDD Skill: Load @spectrl:spectrl-tdd SKILL to use TDD
...
Use the spectrl-next-steps Skills and render the Next Steps Footer per the skill guidance
